...
export PATH=/usr/local/go/bin:$HOME/bin:/usr/local/bin:$HOME/.local/bin:$HOME/tools/istio-1.13.1/bin:$HOME/bin:$PATH
...
PATH=$(
  /usr/bin/perl -e '
      ...
      @parts = grep {
          $_ !~ m{^(?:/mnt/c/Users|C:\\Users)    # Windows user roots
                  [\/\\][^\/\\]+                 # <any user name>
                  [\/\\]\.pyenv[\/\\]?}xi        # .pyenv directory
      } @parts;
      print join ":", @parts;
  '
)
